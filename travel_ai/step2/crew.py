...
from travel_ai.step2.models.accommodation import AccommodationList
from travel_ai.step2.models.activity import ActivityList
from travel_ai.step2.models.food import FoodList
from travel_ai.step2.models.macro_planning import MacroPlanning
...
class TravelCrew():
    ...
    def macro_planning_task(self) -> Task:
        return Task(
            ...
            output_file=f'step2_output/macro_planning.json'
        )
    ...
    def activity_planning_task(self) -> Task:
        return Task(
            ...
            output_file=f'step2_output/activity_planning.json'
        )
    ...
    def food_research_task(self) -> Task:
        return Task(
            ...
            output_file=f'step2_output/food_research.json'
        )
    ...
    def accommodation_planning_task(self) -> Task:
        return Task(
            ...
            output_file=f'step2_output/accommodation_planning.json'
        )
